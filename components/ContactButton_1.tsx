...
const ContactButton_1 = () => {
  return (
    <button className="overflow-hidden relative w-32 p-2 h-12 bg-amber-400 text-black border-none rounded-md text-xl font-bold cursor-pointer z-10 group">
      Contact Us
      ...
      <span className="group-hover:opacity-100 group-hover:duration-1000 duration-100 opacity-0 absolute top-2.5 left-6 z-10">Click</span>
    </button>
  );
}

export default ContactButton_1;
